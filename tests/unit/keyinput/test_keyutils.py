...
def test_key_data_keys():
    ...
    # Some PyQt versions include a 'Keyboard' pseudo-key in the enum which is not
    # represented in key_data.KEYS; ignore it in the check.
    diff = key_names - key_data_names - {"Keyboard"}
    assert not diff
